...
public class SQLDroidResultSet implements ResultSet {
  ...
  public boolean absolute(int row) throws SQLException {
    Log.v(" ********************* not implemented @ " + DebugPrinter.getFileName() + " line " + DebugPrinter.getLineNumber());
    return false;
  }
  ...
  throws SQLException {
    Log.v(" ********************* not implemented correctly - Calendar is ignored. @ " + DebugPrinter.getFileName() + " line " + DebugPrinter.getLineNumber());
